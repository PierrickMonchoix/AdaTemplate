...
package body Test_Conditions is
   ...
   begin
      Test_And_Detect_Fail
        (B        => All_Tests_Passed, Identifier => "test Test_Conditions if",
         Equality =>
           Le_Nombre_Est_Il_Pair (8) and not Le_Nombre_Est_Il_Pair (13));

      Test_And_Detect_Fail
        (B => All_Tests_Passed, Identifier => "test Test_Conditions if conci",
         Equality =>
           Le_Nombre_Est_Il_Pair_Conci (8) and
           not Le_Nombre_Est_Il_Pair_Conci (13));

      Test_And_Detect_Fail
        (B => All_Tests_Passed, Identifier => "test Test_Conditions else if",
         Equality =>
      ...
      Test_And_Detect_Fail
        (B => All_Tests_Passed, Identifier => "test Test_Conditions case",
         Equality =>
